...
function* mergeSortProcess(unsortedArray) {
	...
	const sortedLeftArray = yield* mergeSortProcess(unsortedLeftArray);
	const sortedRightArray = yield* mergeSortProcess(unsortedRightArray);

	const mergedArray = yield* merge(sortedLeftArray, sortedRightArray);
	return mergedArray;
}

export { mergeSortProcess as default };
